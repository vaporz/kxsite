...
linkTitle: "软件和课程"
heading: "软件和课程"
description: "勘星科技航天任务编程控制系统，支持Scratch、Python、C++等多种编程语言，让学生通过编程自动化完成航天任务，打造独具特色的航天编程课程体系。"
keywords: "航天编程课程,航天编程软件,青少年编程教育,Scratch编程,Python编程,航天任务编程控制系统"
menu: main
weight: 20
image: images/banner.jpg
image_alt: "航天任务模拟软件和编程课程"
tags:
...
<img src="/images/scenes.jpg" alt="航天任务模拟场景_火箭发射卫星入轨火星着陆" title="航天任务模拟" width=100%/>
</div>
<div style="text-align: center;">
<img src="/images/gui.png" alt="航天任务模拟操作界面_图形化编程控制" title="航天任务编程控制" width=100%/>
</div>
&nbsp;
...
<div style="text-align: center;">
<img src="/images/courses.png" alt="青少年航天编程课程体系_航天科普课程" title="航天编程课程" width=100%/>
</div>
<div style="text-align: center;">
<img src="/images/program1.png" alt="航天任务编程界面_学生编写程序控制航天器" title="航天编程控制系统" width=100%/>
</div>
<div style="text-align: center;">
...
本系统支持多种编程语言：
<div style="text-align: center;">
<img src="/images/program.jpg" alt="航天编程支持的语言_Scratch_Python_C_C++_Go_PHP" title="支持的编程语言" width=100%/>
</div>
